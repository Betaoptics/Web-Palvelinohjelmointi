...
class CustomersDb {
  ...
  public function __construct() {
    try {
        $this->dbConnection = new PDO('mysql:host=mysql.labranet.jamk.fi;dbname=M3268_2;charset=utf8',
...
EndOfSQL;
    ...
    $resultObj->bindValue(':id', "$id", PDO::PARAM_STR);
    $resultObj->execute();

    $customerObj = $resultObj->fetch(PDO::FETCH_OBJ);
